...
document.onreadystatechange = function () {
	...
	$(function(){
		...
		$(".dropdown-menu li a").click(function(){
		  ...
		  $('#geoType').val($(this).attr('data-val'));
	    });
	...
	$('#getEstimate').click(function(){
		...
		if(checkValidate && search!=''){
			...
			var urlToExecute = webUrl+'sample-poi-code?cityzip='+search;
	...
	$('#searchByProperty').click(function(){
		...
		if(checkValidate && search!=''){
			...
			var geoValue = $('#geoVal').val();
				
				
			var urlToExecute = webUrl+'communitysample?address='+search+'&geoType='+geoType;
			
			if(geoValue!=''){
				urlToExecute +='&geoValue='+geoValue;
			}
	...
	function refreshData(checkedArr,streetAddress,radiusVal){
		$.ajax({
				...
				success:function(response) {
					$('.ajax-loader').hide();
					$("#communityContent").html(response);										
